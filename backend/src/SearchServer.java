...
public class SearchServer {
    ...
    public static void start(
        ...
        server.createContext(
                "/api/document",
                SearchServer::handleDocument
        );

        server.createContext(
                "/api/stats",
                SearchServer::handleStats
        );
    ...
    private static void handleSearch(
        ...
        switch (path) {
            ...
            case "/api/search/near": {
                ...
                String[] first =
                        Tokenizer.tokenize(term1);

                String[] second =
                        Tokenizer.tokenize(term2);
